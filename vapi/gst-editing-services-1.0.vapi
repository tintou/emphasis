/* gst-editing-services-1.0.vapi generated by vapigen-0.36, do not modify. */
...
namespace GES {
	...
	public abstract class Clip : GES.Container, GES.Extractable, GES.MetaContainer {
		...
		[NoWrapper]
		public virtual GES.TrackElement create_track_element (GES.TrackType type);
		[NoWrapper]
		public virtual GLib.List<GES.TrackElement> create_track_elements (GES.TrackType type);
	}
	...
	public class Layer : GLib.InitiallyUnowned, GES.Extractable, GES.MetaContainer {
		...
		public bool add_clip (owned GES.Clip clip);
	...
	[CCode (cheader_filename = "ges/ges.h", type_id = "ges_smart_mixer_get_type ()")]
	public class SmartMixer : Gst.Bin, Gst.ChildProxy {
		[CCode (array_length = false)]
		public weak void* _ges_reserved[4];
		public weak Gst.Caps caps;
		public bool disable_zorder_alpha;
		public GLib.Mutex @lock;
		public weak Gst.Element mixer;
		public weak GLib.HashTable<void*,void*> pads_infos;
		public weak Gst.Pad srcpad;
		[CCode (has_construct_function = false, type = "GstElement*")]
		public SmartMixer (GES.Track track);
	}
	...
	public class Timeline : Gst.Bin, GES.Extractable, GES.MetaContainer, Gst.ChildProxy {
		...
		public bool add_track (GES.Track track);
	...
	public abstract class TimelineElement : GLib.InitiallyUnowned, GES.Extractable, GES.MetaContainer {
		...
		public void get_child_property_by_pspec (GLib.ParamSpec pspec, GLib.Value value);
		public Gst.ClockTime get_duration ();
		...
		public virtual bool lookup_child (string prop_name, GLib.Object child, out GLib.ParamSpec pspec);
		[NoWrapper]
		public virtual bool paste (GES.TimelineElement ref_element, Gst.ClockTime paste_position);
		...
		public bool set_child_property (string property_name, GLib.Value value);
	...
	public class Track : Gst.Bin, GES.MetaContainer, Gst.ChildProxy {
		...
		public bool add_element (owned GES.TrackElement object);
		public bool commit ();
	...
	public abstract class TrackElement : GES.TimelineElement, GES.Extractable, GES.MetaContainer {
		...
		public signal void control_binding_reomved (Gst.ControlBinding object);
	}
	...
	public abstract class VideoSource : GES.Source, GES.Extractable, GES.MetaContainer {
		...
		[NoWrapper]
		public virtual Gst.Element create_source (GES.TrackElement object);
	}
	...
	public enum TrackType {
		...
		TEXT,
		CUSTOM;
		public static unowned string name (GES.TrackType type);
	}
	...
	[CCode (cheader_filename = "ges/ges.h", has_target = false)]
	public delegate GLib.List<GES.TrackElement> CreateTrackElementsFunc (GES.Clip clip, GES.TrackType type);
	[CCode (cheader_filename = "ges/ges.h", has_target = false)]
